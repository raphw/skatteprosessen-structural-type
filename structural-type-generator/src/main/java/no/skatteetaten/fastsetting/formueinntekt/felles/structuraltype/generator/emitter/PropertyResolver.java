...
public interface PropertyResolver {
    ...
    default MethodSpec trial(
        ...
        if (implemented) {
            ...
            if (defined) {
                code.beginControlFlow("try")
                    ...
                    .addStatement("return $T.of($N)", Optional.class, name.equals("exception") ? "exception0" : "exception")
                    .endControlFlow()
                    .build();
            } else {
        ...
        return builder.returns(ParameterizedTypeName.get(Optional.class, RuntimeException.class))
    ...
    default MethodSpec copyOf(
        ClassName structure, CodeBlock value, List<String> names,
