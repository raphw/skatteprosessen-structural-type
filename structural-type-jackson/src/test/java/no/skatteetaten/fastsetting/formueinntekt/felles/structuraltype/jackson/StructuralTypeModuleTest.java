...
public class StructuralTypeModuleTest {
    ...
    @Before
    public void setUp() {
        objectMapper = new ObjectMapper().registerModule(new StructuralTypeModule());
    }
    ...
    public void can_write_expansion_property() throws Exception {
        ...
        assertThat(objectMapper.writeValueAsString(structure)).isEqualTo("{\"nested\":{\"$value\":\"foo\",\"value\":null}}");
    }
    ...
    public void can_write_nested_property() throws Exception {
        ...
        assertThat(objectMapper.writeValueAsString(structure)).isEqualTo("{\"nested\":{\"$value\":null,\"value\":\"foo\"}}");
    }
    ...
    public void can_serialize_projection() throws Exception {
        ...
        assertThat(objectMapper.writeValueAsString(wrapper)).isEqualTo("{\"outer\":{\"inner\":{\"value\":\"foo\"}}}");
    }
}
